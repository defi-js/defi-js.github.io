...
export namespace SpookySwap {
  ...
  export function register() {
    PositionFactory.register({
      ...
      "ftm:SpookySwap:LP:ORBS/USDC": (args, oracle) => new LP(args, oracle, orbs(), usdc(), "0x4FaA520fe975228F54b30c6996129950E975BD8f"),
      "ftm:SpookySwap:LP:ORBS/FTM": (args, oracle) => new LP(args, oracle, orbs(), ftm(), "0x3Ae87E47c69144d1794a78c0709485978C1002A5"),
